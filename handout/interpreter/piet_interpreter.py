...
class PietInterpreter:
    def __init__(self, image):
        ...
        self.x, self.y = 0, 0  # Current codel coordinates
    ...
    def perform_operation(self, operation):
        ...
        if operation == 'push':
            ...
            self.command_string += chr(ch_out)
    ...
    def run(self):
        ...
        while self.get_color(self.x, self.y) != 'black':
            ...
            logging.info(current_color)
            # Determine the hue and lightness changes between current and next colors
            if current_color != 'black' and next_color != 'black' and current_color != 'white':
